...
A simple exercise in modular arithmetic. Except for the edge cases.
## Code
...
* [`day1-part2-90.tcl` &mdash; Rethinking things for Tcl 9.0](day1-part2-90.tcl)
## Data
* [the sample data from the first part](day1-example.txt)
* [the actual sequence to decode](day1.txt)
