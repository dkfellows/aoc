...
The tricky bit here is determining if a rectilinear line segment intersects with a rectangle; that's not too hard either... except there's a lot of coordinates about and many opportunities to make silly blunders. The primary optimisation is knowing that "small" rectangles can be ignored without doing a line segment scan.
